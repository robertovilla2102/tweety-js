// Este módulo va a ser responsable de mantener todos los tweets y darnos métodos para interactuar con ellos.
...
function add (name, content) {
    data.unshift({ name: name, content: content , id:contador});
    contador++
